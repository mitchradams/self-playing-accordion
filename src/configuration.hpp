...
static const std::vector<int> Col1PullFreqs = {364, 216, 261, 302, 389, 432, 515, 605, 777, 869, 1040};
...
static std::vector<std::string> NotesInOrder = {"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"};

static double C1Freq = 32.70319566257483;
